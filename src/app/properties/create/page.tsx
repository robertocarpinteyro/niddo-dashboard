  ...
  return (
    <Create saveButtonProps={saveButtonProps}>
      <Form {...customFormProps} layout="vertical">
        <Row gutter={16}>
          ...
          <Col span={12}>
            ...
            <Form.Item
              ...
              name="subtype"
            >
              <Select placeholder="Selecciona un subtipo">
          ...
          <Col span={12}>
            ...
            {/* Siempre establecer la unidad */}
            <Form.Item name={["area", "unit"]} initialValue="m2" hidden>
              <Input />
            </Form.Item>
          </Col>
        </Row>
        ...
        {/* Campos hidden para valores por defecto */}
        <Form.Item name="currency" initialValue="MXN" hidden>
          <Input />
        </Form.Item>

        <Form.Item name={["location", "country"]} initialValue="México" hidden>
          <Input />
        </Form.Item>
      </Form>
    </Create>
